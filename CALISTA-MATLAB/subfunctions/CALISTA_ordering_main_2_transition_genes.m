function [Results]=CALISTA_ordering_main_2_transition_genes(DATA,INPUTS,Results,cell_assignments)
...
for clust=1:Results.expected_clusters
    ...
    idx_cells_actual_clust=find(Results.final_groups==clust)';    
     for i=1:length(edges_2_check)
        ...
        for j=1:length(Results.GENES.tot_transition_genes)
            ...
            exp_cells_actual_clust_actual_gene=Results.GENES.mRNA_tot_transition_genes(idx_cells_actual_clust,j)+1;
