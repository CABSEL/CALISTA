function [Results]=CALISTA_path_selected_genes(Results,INPUTS,selected_data,selected_genes)
...
%     n_transition_genes=length(idx_actual_transition_genes);
    ...
    path_mRNA_all{i}=selected_data(idx_cells_in_path,:);
...
%         
%         transition_expression= selected_data(idx_cells_in_path,:);
...
%         %     set(cgo,)
%         set(cgo,'RowLabels',selected_genes)
...
% Plot marker genes
[Results]= plot_selected_genes(Results);
