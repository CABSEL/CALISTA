function [h,NumberOfEdges,IDXCOLORMARK3]=AddGraph_after_LI_GUI(nodes,colorMARK2,x_center,y_center,z_center,ClusterGroup2,expected_clusters,normed_pseudotime,score3,legendInfo,az,el,varargin)
