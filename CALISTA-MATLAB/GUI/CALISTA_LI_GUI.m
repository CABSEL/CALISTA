...
if cluster_cut==1
    ...
    if ~Proceed
        ...
        axes(handles_axes1)
        cla(handles_axes1);
        [Results_GUI]=cluster_distance_GUI(DATA,Results_GUI,handles_graphtextwarning,handles_axes1,handles_uipanel1);
...
grid on
h=[];
[h]=AddGraph_GUI(Results_GUI.cluster_distance,Results_GUI.colorMARK_calista,Results_GUI.TRANSITION.x_center,Results_GUI.TRANSITION.y_center,Results_GUI.TRANSITION.z_center,Results_GUI.final_groups,Results_GUI.expected_clusters,Results_GUI.cell_cluster_progression,Results_GUI.score3,Results_GUI.legendInfo_calista,checked_boxes);
